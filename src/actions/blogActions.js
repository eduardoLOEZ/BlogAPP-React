...
export const updateBlogAction = (blog) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(
            `http://localhost:8000/blogs/put/${blog.id}/`, blog, config
        )
...
export const deleteBlogAction = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.delete(
            `http://localhost:8000/blogs/delete/${id}`, config
        )
...
export const createBlogComment = (id, text) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(
            `http://localhost:8000/blogs/comment/${id}/`, text, config
        )
...
export const blogActionDetails = (id) => async (dispatch, getState) => {
    ...
    try {
        ...
        const { data } = await axios.get(`http://localhost:8000/blogs/get/${id}/`, config);
...
export const listBlogs = () => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(`http://localhost:8000/blogs/get/`, config);
